...
## Project Structure
    ...
    ├── ideapros_llc_doya_31948  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_doya_31948`
...
2. Clone this repo and `cd ideapros_llc_doya_31948`
